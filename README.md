...
- `2026.8` (or `2026.08`) under represent current month and year. Replace with current date details.
- If the automation is not already on `2026.8.x` / `2026.08.x`, set `Blueprint versjon` to `2026.08.00`.
- If it is already on `2026.8.x` (or `2026.08.x`), increase `x` by `1`.
